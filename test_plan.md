...
#### 4.2.1 CLI Interface (test_cli.py)

**Файл:** `tests/unit/test_cli.py`

| ID Теста | Название | Описание | Приоритет |
|----------|----------|----------|-----------|
| UT-CLI-001 | test_build_cli_parser_returns_argument_parser | Возврат ArgumentParser | Высокий |
| UT-CLI-002 | test_build_cli_parser_has_file_argument | Аргумент --file | Высокий |
| UT-CLI-003 | test_build_cli_parser_has_output_argument | Аргумент --output | Высокий |
| UT-CLI-004 | test_build_cli_parser_has_list_formats_argument | Аргумент --list-formats | Средний |
| UT-CLI-005 | test_build_cli_parser_has_pretty_argument | Аргумент --pretty | Средний |
| UT-CLI-006 | test_build_cli_parser_has_export_format_argument | Аргумент --export-format | Средний |
| UT-CLI-007 | test_build_cli_parser_has_version_argument | Аргумент --version | Низкий |
| UT-CLI-008 | test_build_cli_parser_has_verbose_argument | Аргумент --verbose | Низкий |
| UT-CLI-009 | test_configure_logging_verbose | Логирование verbose=True | Низкий |
| UT-CLI-010 | test_configure_logging_quiet | Логирование verbose=False | Низкий |
| UT-CLI-011 | test_main_version_flag | Флаг --version | Высокий |
| UT-CLI-012 | test_main_list_formats_flag | Флаг --list-formats | Высокий |
| UT-CLI-013 | test_main_no_file_shows_help | Без --file показывает справку | Высокий |
| UT-CLI-014 | test_main_missing_file_returns_error | Отсутствующий файл | Высокий |
| UT-CLI-015 | test_main_unsupported_format_returns_error | Неподдерживаемый формат | Высокий |
| UT-CLI-016 | test_main_successful_parsing | Успешный парсинг | Высокий |
| UT-CLI-017 | test_main_document_not_found_error | DocumentNotFoundError | Высокий |
| UT-CLI-018 | test_main_unsupported_format_error | UnsupportedFormatError | Высокий |
| UT-CLI-019 | test_main_parsing_failed_error | ParsingFailedError | Высокий |
| UT-CLI-020 | test_main_corrupted_file_error | CorruptedFileError | Высокий |
| UT-CLI-021 | test_main_parser_error | ParserError | Высокий |
| UT-CLI-022 | test_main_generic_exception | Общее исключение | Высокий |
| UT-CLI-023 | test_main_with_output_file | Сохранение в файл | Высокий |
| UT-CLI-024 | test_main_with_pretty_json | Красивый JSON | Средний |
| UT-CLI-025 | test_main_default_export_format_report | Формат report по умолчанию | Средний |

**Итого:** 25 тестов

---

### 4.3 Models Module (Модели)

#### 4.3.1 DocumentMetadata (test_parsed_content.py)
...
#### 4.3.2 TextElement (test_parsed_content.py)
...
#### 4.3.3 ParsedContent (test_parsed_content.py)
...
#### 4.3.4 Exceptions (test_exceptions.py)
...
**Итого Models:** 28 + 18 = 46 тестов

---

### 4.4 Utils Module (Утилиты)

#### 4.4.1 semantic_json (test_semantic_json.py)
...
#### 4.4.3 file_metrics (test_file_metrics.py)
...
**Итого Utils:** 30 + 25 + 19 = 74 теста

---

### 4.5 Parsers Module (Парсеры)

#### 4.5.1 HtmlParser (test_html_parser.py)
...
#### 4.5.2 PdfParser (test_pdf_parser.py)
...
#### 4.5.3 DocxParser (test_docx_parser.py)
...
#### 4.5.4 DocParser (test_doc_parser.py)
...
#### 4.5.5 DjvuParser (test_djvu_parser.py)

**Файл:** `tests/unit/parsers/test_djvu_parser.py`

| ID Теста      | Название                                            | Описание                             | Приоритет |
| ---------------| -----------------------------------------------------| --------------------------------------| -----------|
| UT-PARSER-078 | test_djvu_parser_supported_extensions               | Поддерживаемые расширения            | Высокий   |
| UT-PARSER-079 | test_djvu_parser_missing_djvutxt_raises_error       | Отсутствие djvutxt                   | Высокий   |
| UT-PARSER-080 | test_djvu_parser_missing_djvused_raises_error       | Отсутствие djvused                   | Высокий   |
| UT-PARSER-081 | test_djvu_parser_extract_text_command_failure       | Ошибка команды извлечения текста     | Высокий   |
| UT-PARSER-082 | test_djvu_parser_extract_text_empty_output          | Пустой вывод извлечения текста       | Высокий   |
| UT-PARSER-083 | test_djvu_parser_extract_metadata_command_failure   | Ошибка команды извлечения метаданных | Высокий   |
| UT-PARSER-084 | test_djvu_parser_extract_metadata_pages_parsing     | Парсинг количества страниц           | Высокий   |
| UT-PARSER-085 | test_djvu_parser_extract_metadata_pages_non_numeric | Не-числовое количество страниц       | Средний   |
| UT-PARSER-086 | test_djvu_parser_extract_structure_from_text        | Структура из текста                  | Высокий   |
| UT-PARSER-087 | test_djvu_parser_extract_structure_single_page      | Одностраничная структура             | Средний   |
| UT-PARSER-088 | test_djvu_parser_missing_file                       | Отсутствующий файл                   | Высокий   |
| UT-PARSER-089 | test_djvu_parser_djv_extension                      | Расширение .djv                      | Средний   |
| UT-PARSER-090 | test_djvu_parser_run_method_success                 | Успешный _run метод                  | Средний   |
| UT-PARSER-091 | test_djvu_parser_run_method_missing_tool            | Отсутствие инструмента в _run        | Высокий   |
| UT-PARSER-092 | test_djvu_parser_run_method_exception               | Исключение в _run                    | Высокий   |
| UT-PARSER-093 | test_djvu_parser_parse_full_flow                    | Полный поток парсинга                | Высокий   |
| UT-PARSER-094 | test_djvu_parser_repr                               | Строковое представление              | Низкий    |
| UT-PARSER-095 | test_djvu_parser_get_file_info                      | Информация о файле                   | Средний   |
| UT-PARSER-096 | test_djvu_parser_unicode_error_handling             | Обработка unicode ошибок             | Средний   |
| UT-PARSER-097 | test_djvu_parser_metadata_raw_meta                  | raw_meta в метаданных                | Низкий    |

**Итого Parsers:** 20 + 20 + 22 + 15 + 20 = 97 тестов

---

### 4.6 API Module

#### 4.6.1 App (test_app.py)
...
| UT-API-024 | test_get_job_stats_not_found            | Статистика несуществующей задачи | Высокий   |
| UT-API-025 | test_get_job_ast_not_found              | AST несуществующей задачи        | Высокий   |
| UT-API-026 | test_get_job_export_not_found           | Экспорт несуществующей задачи    | Высокий   |
| UT-API-027 | test_get_job_export_invalid_format      | Экспорт с неверным форматом      | Средний   |

---

#### 4.6.2 Jobs (test_jobs.py)

**Файл:** `tests/unit/api/test_jobs.py`

| ID Теста | Название | Описание | Приоритет |
|----------|----------|----------|-----------|
| UT-API-028 | test_job_record_creation | Создание JobRecord | Высокий |
| UT-API-029 | test_job_record_with_webhook | JobRecord с webhook | Высокий |
| UT-API-030 | test_job_record_to_dict | JobRecord в dict | Высокий |
| UT-API-031 | test_job_record_to_dict_datetime_format | Формат datetime в dict | Высокий |
| UT-API-032 | test_job_record_to_dict_excludes_temp_path | Исключение temp_path | Средний |
| UT-API-033 | test_job_record_to_dict_excludes_result_when_none | Исключение None result | Средний |
| UT-API-034 | test_queue_start | Запуск очереди | Высокий |
| UT-API-035 | test_queue_stop | Остановка очереди | Высокий |
| UT-API-036 | test_enqueue_job | Добавление задачи | Высокий |
| UT-API-037 | test_get_job | Получение задачи | Высокий |
| UT-API-038 | test_get_job_not_found | Задача не найдена | Высокий |
| UT-API-039 | test_worker_processes_job | Обработка задачи worker | Высокий |
| UT-API-040 | test_worker_handles_errors | Обработка ошибок worker | Высокий |
| UT-API-041 | test_worker_cleans_temp_file | Очистка temp файла | Высокий |
| UT-API-042 | test_webhook_sent_on_completion | Webhook при завершении | Высокий |
| UT-API-043 | test_webhook_not_sent_without_url | Нет webhook без URL | Высокий |
| UT-API-044 | test_webhook_sent_on_failure | Webhook при ошибке | Высокий |
| UT-API-045 | test_multiple_jobs_queued | Множественные задачи в очереди | Средний |
| UT-API-046 | test_queue_restart | Перезапуск очереди | Средний |

---

#### 4.6.3 Service (test_service.py)

**Файл:** `tests/unit/api/test_service.py`

| ID Теста   | Название                                              | Описание                | Приоритет |
| ------------| -------------------------------------------------------| -------------------------| -----------|
| UT-API-047 | test_parse_file_sync_html                             | Парсинг HTML файла      | Высокий   |
| UT-API-048 | test_parse_file_sync_pdf                              | Парсинг PDF файла       | Высокий   |
| UT-API-049 | test_parse_file_sync_docx                             | Парсинг DOCX файла      | Высокий   |
| UT-API-050 | test_parse_file_sync_returns_dict                     | Возврат dict            | Высокий   |
| UT-API-051 | test_parse_file_sync_has_required_fields              | Обязательные поля       | Высокий   |
| UT-API-052 | test_parse_file_sync_missing_file                     | Отсутствующий файл      | Высокий   |
| UT-API-053 | test_parse_file_sync_unsupported_format               | Неподдерживаемый формат | Высокий   |
| UT-API-054 | test_save_upload_to_temp_creates_file                 | Создание temp файла     | Высокий   |
| UT-API-055 | test_save_upload_to_temp_correct_suffix               | Верный суффикс          | Высокий   |
| UT-API-056 | test_save_upload_to_temp_default_suffix               | Суффикс по умолчанию    | Средний   |
| UT-API-057 | test_save_upload_to_temp_in_correct_dir               | Верная директория       | Высокий   |
| UT-API-058 | test_save_upload_to_temp_unique_names                 | Уникальные имена        | Высокий   |
| UT-API-059 | test_save_upload_to_temp_preserves_content            | Сохранение контента     | Высокий   |
| UT-API-060 | test_save_upload_to_temp_large_file                   | Большой файл            | Средний   |
| UT-API-061 | test_save_upload_to_temp_empty_content                | Пустой контент          | Низкий    |
| UT-API-062 | test_save_upload_to_temp_unicode_content              | Unicode контент         | Средний   |
| UT-API-063 | test_save_upload_to_temp_cleanup                      | Очистка                 | Средний   |
| UT-API-064 | test_save_upload_to_temp_special_characters_in_suffix | Спецсимволы в суффиксе  | Низкий    |
| UT-API-065 | test_save_upload_to_temp_no_leading_dot               | Без ведущей точки       | Низкий    |
| UT-API-066 | test_save_upload_to_temp_concurrent_calls             | Параллельные вызовы     | Средний   |
| UT-API-067 | test_save_upload_to_temp_directory_permissions        | Права директории        | Низкий    |
| UT-API-068 | test_export_file_sync_json                            | Экспорт в JSON          | Высокий   |
| UT-API-069 | test_export_file_sync_md                              | Экспорт в Markdown      | Высокий   |
| UT-API-070 | test_export_file_sync_report                          | Экспорт в отчёт         | Высокий   |

**Итого API:** 27 + 19 + 24 = 70 тестов

---

### 4.7 Integration Tests (Интеграционные тесты)
...
**Итого Integration:** 18 тестов

---

## 5. Сводная Таблица Тестов

| Модуль          | Файл                   | Количество Тестов | ID Диапазон                   |
| -----------------| ------------------------| -------------------| -------------------------------|
| **Core**        | test_base_parser.py    | 16                | UT-CORE-001 — UT-CORE-016     |
| **Core**        | test_parser_factory.py | 19                | UT-CORE-017 — UT-CORE-035     |
| **CLI**         | test_cli.py            | 25                | UT-CLI-001 — UT-CLI-025       |
| **Models**      | test_parsed_content.py | 28                | UT-MOD-001 — UT-MOD-028       |
| **Models**      | test_exceptions.py     | 18                | UT-MOD-029 — UT-MOD-046       |
| **Utils**       | test_semantic_json.py  | 30                | UT-UTIL-001 — UT-UTIL-030     |
| **Utils**       | test_quality.py        | 25                | UT-UTIL-031 — UT-UTIL-055     |
| **Utils**       | test_file_metrics.py   | 19                | UT-UTIL-056 — UT-UTIL-074     |
| **Parsers**     | test_html_parser.py    | 20                | UT-PARSER-001 — UT-PARSER-020 |
| **Parsers**     | test_pdf_parser.py     | 20                | UT-PARSER-021 — UT-PARSER-040 |
| **Parsers**     | test_docx_parser.py    | 22                | UT-PARSER-041 — UT-PARSER-062 |
| **Parsers**     | test_doc_parser.py     | 15                | UT-PARSER-063 — UT-PARSER-077 |
| **Parsers**     | test_djvu_parser.py    | 20                | UT-PARSER-078 — UT-PARSER-097 |
| **API**         | test_app.py            | 27                | UT-API-001 — UT-API-027       |
| **API**         | test_jobs.py           | 19                | UT-API-028 — UT-API-046       |
| **API**         | test_service.py        | 24                | UT-API-047 — UT-API-070       |
| **Integration** | test_full_pipeline.py  | 18                | IT-001 — IT-018               |
| **ВСЕГО**       | **17 файлов**          | **366**           | —                             |
...
# Генерация отчёта с шаблоном по умолчанию
uv run python -m tests.reporting.qa_report --junit=junit.xml --coverage=coverage.xml --output=qa_report.md
